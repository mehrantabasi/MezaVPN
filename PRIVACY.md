...
MezaVPN is designed to provide an Android VPN connection without advertising or analytics SDKs. This policy explains the information used by the official MezaVPN application distributed through this repository.
...
The official application does not include advertising or analytics SDKs and does not intentionally collect:
